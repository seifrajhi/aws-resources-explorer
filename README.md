...
```
$ python3 aws_inventory.py --list-svcs
acm
apigateway
...
```
$ python3 aws_inventory.py --list-operations
[shield]
...
`$ python3 aws_inventory.py --debug --dry-run`


# Frontend

In order to launch the frontend you need [nvm](https://github.com/nvm-sh/nvm) installed:
